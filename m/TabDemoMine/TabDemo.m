function [TabHandles,PanelWidth,PanelHeight] = TabDemo(NumberOfTabs,TabLabels)
...
% plot(haxes2, 1:2000, sin((1:2000)./12));
% % set(haxes2,'Color',[0.678 0.922 1.0])
% plot(haxes2, 1:2000, rand(1,2000));
% set(haxes2,'Color',[0 0 0]);
...
%--------------- wwy ---------------
% PlotOffset = 40;
% haxes2 = axes('Parent', TabHandles{4,1}, ...
%     'Units', 'pixels', ...
%     'Position', [PlotOffset PlotOffset ...
%     PanelWidth-2*PlotOffset PanelHeight-2*PlotOffset]);
% 
...
%--------------- wwy ---------------
% PlotOffset = 40;
% haxes2 = axes('Parent', TabHandles{6,1}, ...
%     'Units', 'pixels', ...
%     'Position', [PlotOffset PlotOffset ...
%     PanelWidth-2*PlotOffset PanelHeight-2*PlotOffset]);
% 
