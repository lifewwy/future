function [tp,rrr] = Entry_PriceBreak_func(o,c,atr,Nperiod,n1,n2)
...
entryPos = entryPos(1:nCount); % exitPos = exitPos(1:nCount);
profit = profit(1:nCount);  tp = sum(profit); 

% return risk rito
rrr = mean(profit./(n1*atr(entryPos))); 
